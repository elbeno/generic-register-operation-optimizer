...
TEST_CASE("register literal", "[path]") {
    ...
    STATIC_CHECK(r == groov::path{groov::ct_path_element<"reg">{}});
...
TEST_CASE("field literal", "[path]") {
    ...
    STATIC_CHECK(f == groov::path{groov::ct_path_element<"field">{}});
...
TEST_CASE("dot-separated literal", "[path]") {
    ...
    STATIC_CHECK(f == groov::path{groov::ct_path_element<"a">{},
                                  groov::ct_path_element<"b">{},
                                  groov::ct_path_element<"c">{},
                                  groov::ct_path_element<"d">{}});
    CHECK(sizeof(f) == 1);
}
